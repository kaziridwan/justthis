        ...
        <div class="row">
          ...
          <div class="partner-list col-lg-12 head-block">  
            ...
            <div class="static-modal" id="myModalStatic" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content donate-form" >
                  ...
                  <div class="checkbox">
                    <div class="row">
                      <div class="col-lg-12">
                        <textarea class="form-control" placeholder="Leave A Comment" name="" id="" cols="30" rows="5"></textarea></div>                     
                    </div>
                </div>
              ...
              <div class="form-group">
                <a href="<?php site_root(); ?>/donate-info-visa"><img alt="" src="<?php bloginfo('template_url'); ?>/img/page11/give_by_master_card.png" class="pull-left" /></a>
                <a href="<?php site_root(); ?>/donate-paypal"><img alt="" src="<?php bloginfo('template_url'); ?>/img/page11/give_by_paypal.png" class="pull-right" /></a>
              </div>
              
              <div class="give_by_check text-center">
                <div class="title"><a href="<?php site_root(); ?>/general-fund">GIVE BY CHECK</a></div>
              </div>
            </div>
          </div>
          </div>
