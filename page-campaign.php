    ...
    <div class="content-section-a container-fluid">
        <div class="campaign-section row">
            ...
            <div class="col-lg-4 campaign-sidebar">
                ...
                <a href="<?php site_root(); ?>/donate-15"><button class="btn btn-primary btn-lg donate-btn">$15</button></a>
                <a href="<?php site_root(); ?>/donate-150"><button class="btn btn-primary btn-lg donate-btn">$150</button></a>
                <a href="<?php site_root(); ?>/donate-other"><button class="btn btn-primary btn-lg donate-btn">OTHER</button></a>
                
                <br>
                <a href="<?php site_root(); ?>/donate">PAY THIS ENTIRE PROJECT</a>
                <a href="<?php site_root(); ?>/create-account">
